This project explores various ways to check for palindromes in Java, starting from basic strings and moving into advanced data structures. Project Evolution (UC1 - UC13) Foundation: Started with a welcome message (UC1) and simple hardcoded checks (UC2).
